...
export ZSH="/home/boychaboy/.oh-my-zsh"
...
__conda_setup="$('/home/boychaboy/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/boychaboy/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/boychaboy/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/boychaboy/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
if [ -f '/home/boychaboy/google-cloud-sdk/path.zsh.inc' ]; then . '/home/boychaboy/google-cloud-sdk/path.zsh.inc'; fi
